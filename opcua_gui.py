...
def read_confing_parameters():
    ...
    file_path = os.path.abspath(current_dir+'\settings.ini')
    print(file_path)
    config = configparser.ConfigParser()
    a = config.read(file_path)
...
class Ui_Opcua(object):
    ...
    def action_invia_al_plc(self):
        ...
        try:
            ...
            # print("Connessione server opcua ",e)
            error_message_box("impossibile connettersi al server",
                              "errore di connessione",
                              "controllare le impostazioni della scheda di rete, e connessione al PLC")
        finally:
    ...
    def retranslateUi(self, Opcua):
        ...
        self.label.setText(_translate("Opcua", "Inserisci qui il testo da inviare al PLC. Lascia vuoto per cancellare la memoria del PLC"))
